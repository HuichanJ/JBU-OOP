...
class Queue:
    ...
    def __init__(self):
        ...
        self.answer.insert(tk.INSERT, "Queue is created")
        self.q = []
    ...
    def dequeue(self):
        try:
            ...
            self.answer.delete("1.0", END)
            self.answer.insert(tk.INSERT, "Queue is Empty")
...
b1 = Button(top, text="Create Queue", width=10, height=5, command=lambda: qqq())
b1.place(x = 70, y = 120)

b2 = Button(top, text="Enqueue", width=10, height=5, command=lambda: que.enqueue())
b2.place(x = 70, y = 220)

b3 = Button(top, text="Dequeue", width=10, height=5, command=lambda: que.dequeue())
b3.place(x = 70, y = 320)
